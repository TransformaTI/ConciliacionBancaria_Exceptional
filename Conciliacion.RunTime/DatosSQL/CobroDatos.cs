    ...
    public class CobroDatos : Cobro
    {
        ...
        public override bool ChequeTarjetaAltaModifica(Conexion _conexion)
        {
            ...
            { 
                ...
                _conexion.Comando.Parameters.Add(new SqlParameter("@IdDocumento", System.Data.SqlDbType.Int)).Value = this.IdDocumento;
                _conexion.Comando.Parameters.Add(new SqlParameter("@AñoDocumento", System.Data.SqlDbType.Int)).Value = this.AñoDocumento;

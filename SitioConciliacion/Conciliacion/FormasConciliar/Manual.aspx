                    ...
                    <td style="vertical-align: top" colspan="2">
                           ...
                           <div id="dvMuestraAFuturoInternos" style="display: none">
                            ...
                            <table style="width: 100%;" class="lineaVertical bg-color-grisClaro01">
                                <tr>
                                    ...
                                    <td class="etiqueta lineaVertical centradoMedio bg-color-grisOscuro fg-color-blanco"
                                        style="width: 15%; padding: 5px 5px 5px 5px">$<asp:Label runat="server" ID="lblMontoInterno" Text="0.00"></asp:Label>
                                    </td>
                                    <td class="etiqueta lineaVertical centradoMedio" style="width: 1%;">
                                        <asp:Button runat="server" ID="btnGuardarManual" CssClass="boton bg-color-azulOscuro fg-color-blanco"
                                            Text="GUARDAR" Style="margin: 0 0 0 0;" ToolTip="GUARDAR" OnClick="btnGuardarManual_Click" />
                                    </td>
                                </tr>
                            </table>
                        ...
                        <asp:GridView ID="grvPedidos" runat="server" 
                            ...
                            <Columns>
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        <asp:CheckBox ID="chkPedido" runat="server" Checked='<%# Eval("Selecciona") %>' AutoPostBack="True"
                                            OnCheckedChanged="chkPedido_CheckedChanged" />
                                    </ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Cargo" SortExpression="IdCargo">
                                    <ItemTemplate>
                                        <asp:Label ID="lblIdCargo" runat="server" Text='<%# resaltarBusqueda(Eval("IdCargo").ToString()) %>' />
                                    </ItemTemplate>
